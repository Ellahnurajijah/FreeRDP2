...
Version  : 2.11.6
Release  : 44
URL      : https://github.com/FreeRDP/FreeRDP/archive/2.11.6/FreeRDP-2.11.6.tar.gz
Source0  : https://github.com/FreeRDP/FreeRDP/archive/2.11.6/FreeRDP-2.11.6.tar.gz
...
%description dev
dev components for the FreeRDP2 package.


%package lib
Summary: lib components for the FreeRDP2 package.
Group: Libraries
Requires: FreeRDP2-license = %{version}-%{release}

%description lib
lib components for the FreeRDP2 package.


%package license
Summary: license components for the FreeRDP2 package.
Group: Default

%description license
license components for the FreeRDP2 package.


%package man
Summary: man components for the FreeRDP2 package.
Group: Default

%description man
man components for the FreeRDP2 package.


%prep
%setup -q -n FreeRDP-2.11.6
cd %{_builddir}/FreeRDP-2.11.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713372401
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/FreeRDP-%{version}/winpr/libwinpr/sysinfo/cpufeatures/NOTICE %{buildroot}/usr/share/package-licenses/FreeRDP2/ec4468ecfe59c46406d4fc5aca1cee2a83c4d93e || :
export GOAMD64=v2
GOAMD64=v3
pushd clr-build-avx2
%make_install_v3  || :
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libfreerdp-client2.so.2.11.6
/V3/usr/lib64/libfreerdp-server2.so.2.11.6
/V3/usr/lib64/libfreerdp-shadow-subsystem2.so.2.11.6
/V3/usr/lib64/libfreerdp-shadow2.so.2.11.6
/V3/usr/lib64/libfreerdp2.so.2.11.6
/V3/usr/lib64/libwinpr-tools2.so.2.11.6
/V3/usr/lib64/libwinpr2.so.2.11.6
/usr/lib64/libfreerdp-client2.so.2
/usr/lib64/libfreerdp-client2.so.2.11.6
/usr/lib64/libfreerdp-server2.so.2
/usr/lib64/libfreerdp-server2.so.2.11.6
/usr/lib64/libfreerdp-shadow-subsystem2.so.2
/usr/lib64/libfreerdp-shadow-subsystem2.so.2.11.6
/usr/lib64/libfreerdp-shadow2.so.2
/usr/lib64/libfreerdp-shadow2.so.2.11.6
/usr/lib64/libfreerdp2.so.2
/usr/lib64/libfreerdp2.so.2.11.6
/usr/lib64/libwinpr-tools2.so.2
/usr/lib64/libwinpr-tools2.so.2.11.6
/usr/lib64/libwinpr2.so.2
/usr/lib64/libwinpr2.so.2.11.6

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/FreeRDP2/2b8b815229aa8a61e483fb4ba0588b8b6c491890
/usr/share/package-licenses/FreeRDP2/ec4468ecfe59c46406d4fc5aca1cee2a83c4d93e
